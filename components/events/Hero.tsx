        ...
        >
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end items-start p-8">
                  <div className="flex flex-row justify-between items-end w-full gap-5">
                    {/* Event Info */}
                    <div className="flex flex-col items-start gap-2 flex-1 max-w-[584px] md:max-w-[796px] lg:max-w-[1066px]">
                      {/* Event Title */}
                      <h2 className="text-[34px] font-bold leading-[40px] text-white w-full" style={{ fontFamily: "'Inter', sans-serif" }}>
                        {event.title}
                      </h2>
                      ...
                      <div className="flex flex-row items-center gap-1">
                        ...
                        <span className="text-base font-normal leading-5 text-white" style={{ fontFamily: "'Inter', sans-serif" }}>
                          {event.date}
                        </span>
                      </div>
                    </div>
          ...
          {/* <div className="hidden lg:block">
            <button
              ...
              className="absolute left-[-30px] top-1/2 -translate-y-1/2 w-[60px] h-[60px] flex items-center justify-center bg-black rounded-full transition hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0F0F15] z-10"
              aria-label="Previous event"
            >
              <ChevronLeft className="w-4 h-[13px] text-black" aria-hidden="true" />
            </button>

            <button
              type="button"
              onClick={handleNext}
              className="absolute right-[-30px] top-1/2 -translate-y-1/2 w-[60px] h-[60px] flex items-center justify-center bg-black rounded-full transition hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0F0F15] z-10"
              aria-label="Next event"
            >
              <ChevronRight className="w-4 h-[13px] text-black" aria-hidden="true" />
            </button>
          </div> */}
